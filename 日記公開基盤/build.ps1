...
<body><a class="skip" href="#main">本文へ進む</a><header class="top"><div class="shell top-inner"><a class="wordmark" href="${prefix}../index.html">REMNET<span>_</span>K<span>_</span>B<span>_</span>D<span>_</span>S</a><button class="theme" type="button" aria-label="ダークモードに切り替え" aria-pressed="false"><span class="disc" aria-hidden="true"></span><span id="theme-label">夜の色へ</span></button></div></header>
